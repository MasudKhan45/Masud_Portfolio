        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DATA ANALYSIS</h3>
              <h4>Insights from Raw Data</h4>
              <p>
                Transforming messy datasets into clear, actionable insights through
                EDA, statistical analysis, and interactive dashboards that drive decisions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing and fine-tuning ML models for classification, regression,
                and NLP tasks — from EDA to deployment-ready pipelines.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
